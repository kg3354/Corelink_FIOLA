...
// // // // //  * followed by a 1-byte chunk index and 1-byte total chunk number,
// // // // //  * then followed by the chunk data itself.
// // // // //  * @param {String} filePath The file path of the file to be sent via Corelink.
// // // // //  */
// // // // // async function sendFile(filePath) {
...
// // // // //     const watchDir = process.env.WATCH_DIR || "C:/Users/29712/fiola";
...
// // //         const chunk = fileBuffer.slice(i * CHUNK_SIZE, (i + 1) * CHUNK_SIZE);
// // //         const frameNumberBuffer = Buffer.alloc(2);
// // //         frameNumberBuffer.writeUInt8(frameNumber >> 8, 0);
// // //         frameNumberBuffer.writeUInt8(frameNumber & 0xFF, 1);
// // //         const dataToSend = Buffer.concat([
// // //           frameNumberBuffer,
// // //           Buffer.from([i, totalChunks]),
// // //           chunk,
...
// // //         if (receiverActive) {
// // //           sendFile(filePath).then(() => {
// // //             // No need to increment currentFrameNumber here as it is done in sendFile()
// // //           }).catch(err => {
// // //             console.error('Failed to send file:', err);
// // //           });
// // //         } else {
...
// //     const watchDir = process.env.WATCH_DIR || "C:/Users/Research/Desktop/fiola";
...
//         fs.writeFileSync(resultFilePath, fullFile);
