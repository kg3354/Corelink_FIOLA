...
// // //     const endIndex = data.indexOf('--PICKLE-END--');
// // //     if (endIndex !== -1) {
// // //       pickleBuffer = Buffer.concat([pickleBuffer, data.slice(0, endIndex)]);
// // //       console.log('End delimiter found'); // Debug print
// // //       const timestamp = Date.now();
// // //       const resultFilePath = path.join('results', `fiola_result_${timestamp}.pkl`);
...
// // //     }
// // //   } else {
// // //     const startIndex = data.indexOf('--PICKLE-START--');
// // //     if (startIndex !== -1) {
// // //       isReceivingPickle = true;
// // //       pickleBuffer = Buffer.concat([pickleBuffer, data.slice(startIndex + 15)]);
// // //       console.log('Start delimiter found'); // Debug print
// // //     } else {
...
// // // const sendFileToPython = (fileBuffer) => {
...
// const protocol = 'ws';
// const datatype = 'video';
// const CHUNK_SIZE = 8 * 1024; // 4KB chunk size
...
// const sendProcessedData = (fileBuffer) => {
...
//     corelink.send(resultSender, dataToSend);
