...
# # # # #             # Process the frame with FIOLA
# # # # #             process_frame_with_buffer(fio, frame_data, frame_number, batch=1)
...
# # # def process_frame(fio, memmap_image, frame_idx, timestamp, batch):
# # #     try:
# # #         start_time = time()
# # #         num_frames_total = memmap_image.shape[0]
...
# # #         logging.info(f"Total time spent processing frame {frame_idx} (from capture to finish): {total_time}")

# # #     except Exception as e:
# # #         logging.error(f"Error processing frame {frame_idx}: {e}")

# # # def process_frame_with_buffer(fio, frame_data, frame_idx, timestamp, batch):
# # #     try:
# # #         memmap_image = memmap_from_buffer(frame_data)
# # #         process_frame(fio, memmap_image, frame_idx, timestamp, batch)
# # #     except Exception as e:
# # #         logging.error(f"Failed to process frame with buffer: {e}")
...
# # #             # Process the frame with FIOLA
# # #             process_frame_with_buffer(fio, frame_data, frame_number, frame["timestamp"], batch=1)
...
# # #             # Process the frame with FIOLA concurrently
# # #             loop = asyncio.get_event_loop()
# # #             loop.run_in_executor(executor, process_frame_with_buffer, fio, frame_data, frame_number, frame["timestamp"], 1)
...
# FIOLA_POOL_SIZE = 15  # Define the number of FIOLA objects to rotate through
# fio_objects = []
# fio_index = 0
